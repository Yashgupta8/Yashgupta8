...
### 📄 LaTeX Article: Spatio-Temporal Face Analytics

<details>
<summary>Click to expand full LaTeX source code (copyable)</summary>
...
\begin{tikzpicture}[
    node distance=0.5cm,
    box/.style={rectangle, draw, rounded corners, minimum width=1.7cm,
